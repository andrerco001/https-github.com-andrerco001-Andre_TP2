...
class ViewController: UIViewController {
    ...
    //Placez toutes les cartes back et front avec imageview dans cette section
    //--------------------
    ...
    //Créez le tableau (array) de toutes les cartes
    
    var arrayOfImageViews: [UIImageView]!
    var arrayOfAnimalNames = ["hibou.png", "hibou.png", "loup.png", "loup.png", "oiseau.png", "oiseau.png", "phoque.png", "phoque.png", "kangourou.png", "kangourou.png", "poisson.png", "poisson.png"]
    var arrayOfRadomAnimalNames = [String] ()
    ...
    //Section responsable pour faire le random et mettre des images
    ...
    @IBAction func showCard(_ sender: UIButton) {
        ...
        //cette fonction vérifie les cartes
        
        arrayChosenCards.append(arrayOfRadomAnimalNames[sender.tag])
        verification()
        
    }
    //--------------------
    //cette fonction contrôle le temps de contrôle des cartes
    ...
    //fonction qui effectue le cycle des cartes
    func setImagesToCards() {
        var number = 0
        for imgView in arrayOfImageViews {
            imgView.image = UIImage(named: arrayOfRadomAnimalNames[number])
            number = number + 1
            }
    }
    ...
    //fuction pour choix de cartes au hasard
    func randomAnimals() {
        ...
        for _ in 1...numberOfAnimals {
            ...
            arrayOfRadomAnimalNames.append(arrayOfAnimalNames[randomNumber])
            arrayOfAnimalNames.remove(at: randomNumber)
        }
    }
    //--------------------
    //fonction de réinitialisation de la carte. Responsable du redémarrage du logiciel portable
    func resetCards() {
    ...
    //La fonction de vérification de la carte et le temps qui reste visibles pour l'utilisateur
    func verification() {
    ...
    //Les fonctions des objects (cartes)
    //--------------------
    //
    @objc func hideCards() {
  ...
  //--------------------
    @IBAction func reset(_ sender: UIButton) {
        ...
        arrayOfAnimalNames = ["hibou.png", "hibou.png", "loup.png", "loup.png", "oiseau.png", "oiseau.png", "phoque.png", "phoque.png", "kangourou.png", "kangourou.png", "poisson.png", "poisson.png"]
      
        arrayOfRadomAnimalNames = []
        randomAnimals()
        setImagesToCards()
    }
